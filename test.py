...
optimizerRmsProp_d =  RMSprop(
    learning_rate=0.0003,   # Usualmente entre 0.001 y 0.0001
...
gan, generator, discriminator, optimizer_d, optimizer_g = dc.get_gan(layerG,layerResidual,layerAttention,neuronsG,optimizerAdam_g,layerD,neuronsD,optimizerAdam_d,latent_dim,matrixDim,width,height)
dc.train_dcgan(generator, discriminator, gan, dataSet, epochs, batch_size, latent_dim, optimizer_d, optimizer_g, n_critic,"adam") 
