...
def solve(dungeon):
    ...
    while routes:
        ...
        for enemy in enemys:
            ...
            if getNEnemys(newDungeon) == 0 and inDoor(newDungeon): 
        ...
        for move in moves:
            ...
            newDungeon = M.iceSliding(newDungeon,move)
...
def solverWithMoves(dungeon):
    ...
    while routes:
        ...
        for enemy in enemys:
            ...
            if getNEnemys(newDungeon.dungeon) == 0 and inDoor(newDungeon.dungeon): 
                solutions.append(getRoutes(Node(newDungeon,parent=currentNode)))
            else:
        ...
        for move in moves:
            ...
            newDungeon = M.iceSliding(newDungeon.dungeon,move)
